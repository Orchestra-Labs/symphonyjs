...
export const QueryTotalSupplyWithoutOffsetResponse = {
  ...
  is(o: any): o is QueryTotalSupplyWithoutOffsetResponse {
    return o && (o.$typeUrl === QueryTotalSupplyWithoutOffsetResponse.typeUrl || Array.isArray(o.supply) && (!o.supply.length || Coin.is(o.supply[0])));
  },
  isSDK(o: any): o is QueryTotalSupplyWithoutOffsetResponseSDKType {
    return o && (o.$typeUrl === QueryTotalSupplyWithoutOffsetResponse.typeUrl || Array.isArray(o.supply) && (!o.supply.length || Coin.isSDK(o.supply[0])));
  },
  isAmino(o: any): o is QueryTotalSupplyWithoutOffsetResponseAmino {
    return o && (o.$typeUrl === QueryTotalSupplyWithoutOffsetResponse.typeUrl || Array.isArray(o.supply) && (!o.supply.length || Coin.isAmino(o.supply[0])));
  },
...
export const QuerySupplyOfWithoutOffsetRequest = {
  ...
  is(o: any): o is QuerySupplyOfWithoutOffsetRequest {
    return o && (o.$typeUrl === QuerySupplyOfWithoutOffsetRequest.typeUrl || typeof o.denom === "string");
  },
...
export const QuerySupplyOfWithoutOffsetResponse = {
  ...
  is(o: any): o is QuerySupplyOfWithoutOffsetResponse {
    return o && (o.$typeUrl === QuerySupplyOfWithoutOffsetResponse.typeUrl || Coin.is(o.amount));
  },
  isSDK(o: any): o is QuerySupplyOfWithoutOffsetResponseSDKType {
    return o && (o.$typeUrl === QuerySupplyOfWithoutOffsetResponse.typeUrl || Coin.isSDK(o.amount));
  },
  isAmino(o: any): o is QuerySupplyOfWithoutOffsetResponseAmino {
    return o && (o.$typeUrl === QuerySupplyOfWithoutOffsetResponse.typeUrl || Coin.isAmino(o.amount));
  },

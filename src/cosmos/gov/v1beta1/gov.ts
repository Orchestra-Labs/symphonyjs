...
GlobalDecoderRegistry.registerAminoProtoMapping(
  WeightedVoteOption.aminoType,
  WeightedVoteOption.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  DepositParams.aminoType,
  DepositParams.typeUrl,
);
...
export const VotingParams = {
  ...
  isAmino(o: any): o is VotingParamsAmino {
    return (
      o &&
      (o.$typeUrl === VotingParams.typeUrl || Duration.isAmino(o.voting_period))
    );
  },
  encode(
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  VotingParams.aminoType,
  VotingParams.typeUrl,
);

...
import {
  ...
  QueryAccountAddressByIDResponseSDKType,
  QueryParamsRequest,
  QueryParamsResponseSDKType,
  QueryModuleAccountsRequest,
  QueryModuleAccountsResponseSDKType,
  QueryModuleAccountByNameRequest,
  QueryModuleAccountByNameResponseSDKType,
  Bech32PrefixRequest,
  ...
  QueryAccountInfoResponseSDKType,
} from './query';
export class LCDQueryClient {
  ...
  async accountAddressByID(
  ...
  ): Promise<QueryAccountAddressByIDResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryAccountAddressByIDResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  ): Promise<QueryModuleAccountsResponseSDKType> {
  ...
  async moduleAccountByName(
    params: QueryModuleAccountByNameRequest,
  ): Promise<QueryModuleAccountByNameResponseSDKType> {
    const endpoint = `cosmos/auth/v1beta1/module_accounts/${params.name}`;
    return await this.req.get<QueryModuleAccountByNameResponseSDKType>(
      endpoint,
    );
  }
  ...
  ): Promise<Bech32PrefixResponseSDKType> {
  ...
  ): Promise<AddressBytesToStringResponseSDKType> {
  ...
  ): Promise<AddressStringToBytesResponseSDKType> {
  ...
  async accountInfo(
    params: QueryAccountInfoRequest,
  ): Promise<QueryAccountInfoResponseSDKType> {

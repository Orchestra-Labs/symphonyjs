...
GlobalDecoderRegistry.registerAminoProtoMapping(
  HistoricalInfo.aminoType,
  HistoricalInfo.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  CommissionRates.aminoType,
  CommissionRates.typeUrl,
);
...
export const Commission = {
  ...
  isAmino(o: any): o is CommissionAmino {
    return (
      o &&
      (o.$typeUrl === Commission.typeUrl ||
        (CommissionRates.isAmino(o.commission_rates) &&
          Timestamp.isAmino(o.update_time)))
    );
  },
  encode(
    message: Commission,
...
export const Validator = {
  ...
  fromAmino(object: ValidatorAmino): Validator {
    ...
    if (
      ...
      message.unbondingOnHoldRefCount = BigInt(
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  ValAddresses.aminoType,
  ValAddresses.typeUrl,
);
...
export const DVPairs = {
  ...
  isAmino(o: any): o is DVPairsAmino {
    return (
      ...
      (o.$typeUrl === DVPairs.typeUrl ||
        (Array.isArray(o.pairs) &&
          (!o.pairs.length || DVPair.isAmino(o.pairs[0]))))
    );
  },
  encode(
    message: DVPairs,
...
export const DVVTriplets = {
  ...
  isAmino(o: any): o is DVVTripletsAmino {
    return (
      ...
      (o.$typeUrl === DVVTriplets.typeUrl ||
        (Array.isArray(o.triplets) &&
          (!o.triplets.length || DVVTriplet.isAmino(o.triplets[0]))))
    );
  },
  encode(
    message: DVVTriplets,
    ...
    return (
      ...
      (o.$typeUrl === UnbondingDelegation.typeUrl ||
        (typeof o.delegator_address === 'string' &&
          ...
          Array.isArray(o.entries) &&
          (!o.entries.length ||
            UnbondingDelegationEntry.isAmino(o.entries[0]))))
    );
  },
  encode(
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  RedelegationEntry.aminoType,
  RedelegationEntry.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  Redelegation.aminoType,
  Redelegation.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  DelegationResponse.aminoType,
  DelegationResponse.typeUrl,
);
...
export const RedelegationEntryResponse = {
  ...
  isAmino(o: any): o is RedelegationEntryResponseAmino {
    return (
      o &&
      (o.$typeUrl === RedelegationEntryResponse.typeUrl ||
        (RedelegationEntry.isAmino(o.redelegation_entry) &&
          typeof o.balance === 'string'))
    );
  },
  encode(
    ...
    return (
      ...
      (o.$typeUrl === RedelegationResponse.typeUrl ||
        (Redelegation.isAmino(o.redelegation) &&
          Array.isArray(o.entries) &&
          (!o.entries.length ||
            RedelegationEntryResponse.isAmino(o.entries[0]))))
    );
  },
  encode(
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  RedelegationResponse.aminoType,
  RedelegationResponse.typeUrl,
);
...
export const ValidatorUpdates = {
  ...
  isAmino(o: any): o is ValidatorUpdatesAmino {
    return (
      ...
      (o.$typeUrl === ValidatorUpdates.typeUrl ||
        (Array.isArray(o.updates) &&
          (!o.updates.length || ValidatorUpdate.isAmino(o.updates[0]))))
    );
  },
  encode(
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  ValidatorUpdates.aminoType,
  ValidatorUpdates.typeUrl,
);

...
export class LCDQueryClient {
  ...
  async validators(
    ...
    return await this.req.get<QueryValidatorsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async validator(
    params: QueryValidatorRequest,
  ): Promise<QueryValidatorResponseSDKType> {
  ...
  async validatorDelegations(
  ...
  ): Promise<QueryValidatorDelegationsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryValidatorDelegationsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async validatorUnbondingDelegations(
  ...
  ): Promise<QueryValidatorUnbondingDelegationsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryValidatorUnbondingDelegationsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async delegation(
    params: QueryDelegationRequest,
  ): Promise<QueryDelegationResponseSDKType> {
  ...
  async unbondingDelegation(
  ...
  ): Promise<QueryUnbondingDelegationResponseSDKType> {
    ...
    return await this.req.get<QueryUnbondingDelegationResponseSDKType>(
      endpoint,
    );
  }
  ...
  async delegatorDelegations(
  ...
  ): Promise<QueryDelegatorDelegationsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryDelegatorDelegationsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async delegatorUnbondingDelegations(
  ...
  ): Promise<QueryDelegatorUnbondingDelegationsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryDelegatorUnbondingDelegationsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async redelegations(
  ...
  ): Promise<QueryRedelegationsResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryRedelegationsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async delegatorValidators(
  ...
  ): Promise<QueryDelegatorValidatorsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryDelegatorValidatorsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  ): Promise<QueryDelegatorValidatorResponseSDKType> {
  ...
  ): Promise<QueryHistoricalInfoResponseSDKType> {

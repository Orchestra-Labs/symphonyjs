...
import {
  QueryGrantsRequest,
  QueryGrantsResponseSDKType,
  QueryGranterGrantsRequest,
  QueryGranterGrantsResponseSDKType,
  QueryGranteeGrantsRequest,
  QueryGranteeGrantsResponseSDKType,
} from './query';
export class LCDQueryClient {
  ...
  async grants(
    params: QueryGrantsRequest,
  ): Promise<QueryGrantsResponseSDKType> {
    const options: any = {
      params: {},
    };
  ...
  async granterGrants(
  ...
  ): Promise<QueryGranterGrantsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryGranterGrantsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async granteeGrants(
  ...
  ): Promise<QueryGranteeGrantsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.pagination !== 'undefined') {
    ...
    return await this.req.get<QueryGranteeGrantsResponseSDKType>(
      endpoint,
      options,
    );
  }

...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryGrantsRequest.aminoType,
  QueryGrantsRequest.typeUrl,
);
...
export const QueryGrantsResponse = {
  ...
  isAmino(o: any): o is QueryGrantsResponseAmino {
    return (
      ...
      (o.$typeUrl === QueryGrantsResponse.typeUrl ||
        (Array.isArray(o.grants) &&
          (!o.grants.length || Grant.isAmino(o.grants[0]))))
    );
  },
  encode(
...
export const QueryGranterGrantsResponse = {
  ...
  isAmino(o: any): o is QueryGranterGrantsResponseAmino {
    return (
      ...
      (o.$typeUrl === QueryGranterGrantsResponse.typeUrl ||
        (Array.isArray(o.grants) &&
          (!o.grants.length || GrantAuthorization.isAmino(o.grants[0]))))
    );
  },
  encode(

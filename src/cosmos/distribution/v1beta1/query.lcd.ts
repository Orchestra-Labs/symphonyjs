...
import {
  ...
  QueryValidatorDistributionInfoResponseSDKType,
...
export class LCDQueryClient {
  ...
  async validatorDistributionInfo(
    params: QueryValidatorDistributionInfoRequest,
  ): Promise<QueryValidatorDistributionInfoResponseSDKType> {
    const endpoint = `cosmos/distribution/v1beta1/validators/${params.validatorAddress}`;
    return await this.req.get<QueryValidatorDistributionInfoResponseSDKType>(
      endpoint,
    );
  }
  ...
  ): Promise<QueryValidatorOutstandingRewardsResponseSDKType> {
    const endpoint = `cosmos/distribution/v1beta1/validators/${params.validatorAddress}/outstanding_rewards`;
    return await this.req.get<QueryValidatorOutstandingRewardsResponseSDKType>(
      endpoint,
    );
  }
  ...
  ): Promise<QueryValidatorCommissionResponseSDKType> {
    const endpoint = `cosmos/distribution/v1beta1/validators/${params.validatorAddress}/commission`;
    return await this.req.get<QueryValidatorCommissionResponseSDKType>(
      endpoint,
    );
  }
  ...
  async validatorSlashes(
  ...
  ): Promise<QueryValidatorSlashesResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    return await this.req.get<QueryValidatorSlashesResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  ): Promise<QueryDelegationRewardsResponseSDKType> {
  ...
  ): Promise<QueryDelegationTotalRewardsResponseSDKType> {
    const endpoint = `cosmos/distribution/v1beta1/delegators/${params.delegatorAddress}/rewards`;
    return await this.req.get<QueryDelegationTotalRewardsResponseSDKType>(
      endpoint,
    );
  }
  ...
  ): Promise<QueryDelegatorWithdrawAddressResponseSDKType> {
    const endpoint = `cosmos/distribution/v1beta1/delegators/${params.delegatorAddress}/withdraw_address`;
    return await this.req.get<QueryDelegatorWithdrawAddressResponseSDKType>(
      endpoint,
    );
  }
  ...
  ): Promise<QueryCommunityPoolResponseSDKType> {

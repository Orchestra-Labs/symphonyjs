...
GlobalDecoderRegistry.registerAminoProtoMapping(
  AppDescriptor.aminoType,
  AppDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  TxDescriptor.aminoType,
  TxDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  AuthnDescriptor.aminoType,
  AuthnDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.register(
  SigningModeDescriptor.typeUrl,
  SigningModeDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  SigningModeDescriptor.aminoType,
  SigningModeDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  ChainDescriptor.aminoType,
  ChainDescriptor.typeUrl,
);
    ...
    return (
      ...
      (o.$typeUrl === InterfaceDescriptor.typeUrl ||
        (typeof o.fullname === 'string' &&
          Array.isArray(o.interface_accepting_messages) &&
          (!o.interface_accepting_messages.length ||
            InterfaceAcceptingMessageDescriptor.isAmino(
              o.interface_accepting_messages[0],
            )) &&
          Array.isArray(o.interface_implementers) &&
          (!o.interface_implementers.length ||
            InterfaceImplementerDescriptor.isAmino(
              o.interface_implementers[0],
            ))))
    );
  },
  encode(
...
GlobalDecoderRegistry.register(
  InterfaceImplementerDescriptor.typeUrl,
  InterfaceImplementerDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  InterfaceImplementerDescriptor.aminoType,
  InterfaceImplementerDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.register(
  InterfaceAcceptingMessageDescriptor.typeUrl,
  InterfaceAcceptingMessageDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  InterfaceAcceptingMessageDescriptor.aminoType,
  InterfaceAcceptingMessageDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.register(
  ConfigurationDescriptor.typeUrl,
  ConfigurationDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  ConfigurationDescriptor.aminoType,
  ConfigurationDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgDescriptor.aminoType,
  MsgDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetAuthnDescriptorRequest.typeUrl,
  GetAuthnDescriptorRequest,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetAuthnDescriptorRequest.aminoType,
  GetAuthnDescriptorRequest.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetAuthnDescriptorResponse.typeUrl,
  GetAuthnDescriptorResponse,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetAuthnDescriptorResponse.aminoType,
  GetAuthnDescriptorResponse.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetChainDescriptorRequest.aminoType,
  GetChainDescriptorRequest.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetChainDescriptorResponse.typeUrl,
  GetChainDescriptorResponse,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetChainDescriptorResponse.aminoType,
  GetChainDescriptorResponse.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetCodecDescriptorRequest.typeUrl,
  GetCodecDescriptorRequest,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetCodecDescriptorRequest.aminoType,
  GetCodecDescriptorRequest.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetCodecDescriptorResponse.typeUrl,
  GetCodecDescriptorResponse,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetCodecDescriptorResponse.aminoType,
  GetCodecDescriptorResponse.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetConfigurationDescriptorRequest.typeUrl,
  GetConfigurationDescriptorRequest,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
...
GlobalDecoderRegistry.register(
  GetConfigurationDescriptorResponse.typeUrl,
  GetConfigurationDescriptorResponse,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetConfigurationDescriptorResponse.aminoType,
  GetConfigurationDescriptorResponse.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetQueryServicesDescriptorRequest.typeUrl,
  GetQueryServicesDescriptorRequest,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetQueryServicesDescriptorRequest.aminoType,
  GetQueryServicesDescriptorRequest.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetQueryServicesDescriptorResponse.typeUrl,
  GetQueryServicesDescriptorResponse,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetQueryServicesDescriptorResponse.aminoType,
  GetQueryServicesDescriptorResponse.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetTxDescriptorRequest.typeUrl,
  GetTxDescriptorRequest,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetTxDescriptorRequest.aminoType,
  GetTxDescriptorRequest.typeUrl,
);
...
GlobalDecoderRegistry.register(
  GetTxDescriptorResponse.typeUrl,
  GetTxDescriptorResponse,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetTxDescriptorResponse.aminoType,
  GetTxDescriptorResponse.typeUrl,
);
...
GlobalDecoderRegistry.register(
  QueryServicesDescriptor.typeUrl,
  QueryServicesDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryServicesDescriptor.aminoType,
  QueryServicesDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.register(
  QueryServiceDescriptor.typeUrl,
  QueryServiceDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryServiceDescriptor.aminoType,
  QueryServiceDescriptor.typeUrl,
);
...
GlobalDecoderRegistry.register(
  QueryMethodDescriptor.typeUrl,
  QueryMethodDescriptor,
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryMethodDescriptor.aminoType,
  QueryMethodDescriptor.typeUrl,
);

...
export const Params = {
  ...
  is(o: any): o is Params {
    return o && (o.$typeUrl === Params.typeUrl || (o.exchangePool instanceof Uint8Array || typeof o.exchangePool === "string") && (o.minStabilitySpread instanceof Uint8Array || typeof o.minStabilitySpread === "string") && typeof o.taxReceiver === "string");
  },
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || (o.exchange_pool instanceof Uint8Array || typeof o.exchange_pool === "string") && (o.min_stability_spread instanceof Uint8Array || typeof o.min_stability_spread === "string") && typeof o.tax_receiver === "string");
  },
  ...
  toAmino(message: Params): ParamsAmino {
    ...
    obj.tax_receiver = message.taxReceiver === "" ? undefined : message.taxReceiver;
    return obj;
  },

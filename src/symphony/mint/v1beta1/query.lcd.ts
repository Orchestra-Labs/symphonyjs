...
export class LCDQueryClient {
  ...
  async params(
    ...
    const endpoint = `symphony/mint/v1beta1/params`;
    return await this.req.get<QueryParamsResponseSDKType>(endpoint);
  }
  /* EpochProvisions returns the current minting epoch provisions value. */
  async epochProvisions(
    _params: QueryEpochProvisionsRequest = {},
  ): Promise<QueryEpochProvisionsResponseSDKType> {
    const endpoint = `symphony/mint/v1beta1/epoch_provisions`;

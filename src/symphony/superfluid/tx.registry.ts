...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
  ['/symphony.superfluid.MsgSuperfluidDelegate', MsgSuperfluidDelegate],
  ['/symphony.superfluid.MsgSuperfluidUndelegate', MsgSuperfluidUndelegate],
  ['/symphony.superfluid.MsgSuperfluidUnbondLock', MsgSuperfluidUnbondLock],
  [
  ...
  ['/symphony.superfluid.MsgUnPoolWhitelistedPool', MsgUnPoolWhitelistedPool],
  [
  ...
  ['/symphony.superfluid.MsgUnbondConvertAndStake', MsgUnbondConvertAndStake],
];

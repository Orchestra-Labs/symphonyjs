...
export interface Query {
  ...
  ): Promise<QueryUnpoolWhitelistResponse>;
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.totalDelegationByValidatorForDenom =
      this.totalDelegationByValidatorForDenom.bind(this);
  ...
  assetType(request: AssetTypeRequest): Promise<AssetTypeResponse> {
    ...
    return promise.then(data =>
      AssetTypeResponse.decode(new BinaryReader(data)),
    );
  }
  allAssets(request: AllAssetsRequest = {}): Promise<AllAssetsResponse> {
    ...
    return promise.then(data =>
      AllAssetsResponse.decode(new BinaryReader(data)),
    );
  }
  assetMultiplier(
    request: AssetMultiplierRequest,
    ...
    return promise.then(data =>
      AssetMultiplierResponse.decode(new BinaryReader(data)),
    );
  }
  allIntermediaryAccounts(
    request: AllIntermediaryAccountsRequest = {
    ...
    return promise.then(data =>
      AllIntermediaryAccountsResponse.decode(new BinaryReader(data)),
    );
  }
  connectedIntermediaryAccount(
    request: ConnectedIntermediaryAccountRequest,
    ...
    return promise.then(data =>
      ConnectedIntermediaryAccountResponse.decode(new BinaryReader(data)),
    );
  }
  totalDelegationByValidatorForDenom(
    request: QueryTotalDelegationByValidatorForDenomRequest,
    ...
    const data =
      QueryTotalDelegationByValidatorForDenomRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.superfluid.Query',
      'TotalDelegationByValidatorForDenom',
      data,
    ...
    return promise.then(data =>
      QueryTotalDelegationByValidatorForDenomResponse.decode(
  ...
  totalSuperfluidDelegations(
    ...
    return promise.then(data =>
      TotalSuperfluidDelegationsResponse.decode(new BinaryReader(data)),
    );
  }
  superfluidDelegationAmount(
    request: SuperfluidDelegationAmountRequest,
    ...
    return promise.then(data =>
      SuperfluidDelegationAmountResponse.decode(new BinaryReader(data)),
    );
  }
  superfluidDelegationsByDelegator(
    request: SuperfluidDelegationsByDelegatorRequest,
    ...
    return promise.then(data =>
      SuperfluidDelegationsByDelegatorResponse.decode(new BinaryReader(data)),
    );
  }
  superfluidUndelegationsByDelegator(
    request: SuperfluidUndelegationsByDelegatorRequest,
    ...
    return promise.then(data =>
      SuperfluidUndelegationsByDelegatorResponse.decode(new BinaryReader(data)),
    );
  }
  superfluidDelegationsByValidatorDenom(
    request: SuperfluidDelegationsByValidatorDenomRequest,
    ...
    return promise.then(data =>
      SuperfluidDelegationsByValidatorDenomResponse.decode(
        new BinaryReader(data),
      ),
    );
  }
  ...
  totalDelegationByDelegator(
    ...
    const data =
      QueryTotalDelegationByDelegatorRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.superfluid.Query',
      'TotalDelegationByDelegator',
      data,
    ...
    return promise.then(data =>
      QueryTotalDelegationByDelegatorResponse.decode(new BinaryReader(data)),
    );
  }
  unpoolWhitelist(
    request: QueryUnpoolWhitelistRequest = {},
    ...
    return promise.then(data =>
      QueryUnpoolWhitelistResponse.decode(new BinaryReader(data)),
    );
  }
  userConcentratedSuperfluidPositionsDelegated(
    request: UserConcentratedSuperfluidPositionsDelegatedRequest,
    ...
    return promise.then(data =>
      UserConcentratedSuperfluidPositionsDelegatedResponse.decode(
        new BinaryReader(data),
      ),
    );
  }
  userConcentratedSuperfluidPositionsUndelegating(
    ...
    return promise.then(data =>
      UserConcentratedSuperfluidPositionsUndelegatingResponse.decode(
        new BinaryReader(data),
      ),
    );
  }
  restSupply(
  ...
  ): Promise<QueryRestSupplyResponse> {
    ...
    return promise.then(data =>
      QueryRestSupplyResponse.decode(new BinaryReader(data)),
    );
  }
}
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    estimateSuperfluidDelegatedAmountByValidatorDenom(
      ...
      return queryService.estimateSuperfluidDelegatedAmountByValidatorDenom(
        request,
      );
    },
    totalDelegationByDelegator(
    ...
    userConcentratedSuperfluidPositionsUndelegating(
      ...
      return queryService.userConcentratedSuperfluidPositionsUndelegating(
        request,
      );
    },
    restSupply(

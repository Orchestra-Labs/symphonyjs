...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/symphony.protorev.v1beta1.MsgSetHotRoutes", MsgSetHotRoutes], ["/symphony.protorev.v1beta1.MsgSetDeveloperAccount", MsgSetDeveloperAccount], ["/symphony.protorev.v1beta1.MsgSetMaxPoolPointsPerTx", MsgSetMaxPoolPointsPerTx], ["/symphony.protorev.v1beta1.MsgSetMaxPoolPointsPerBlock", MsgSetMaxPoolPointsPerBlock], ["/symphony.protorev.v1beta1.MsgSetInfoByPoolType", MsgSetInfoByPoolType], ["/symphony.protorev.v1beta1.MsgSetBaseDenoms", MsgSetBaseDenoms]];

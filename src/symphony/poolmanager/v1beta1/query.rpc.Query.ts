...
export interface Query {
  ...
  ): Promise<ListPoolsByDenomResponse>;
  /**
  ...
  ): Promise<AllTakerFeeShareAgreementsResponse>;
  /**
  ...
  ): Promise<AllRegisteredAlloyedPoolsResponse>;
}
export class QueryClientImpl implements Query {
  ...
  params(request: ParamsRequest = {}): Promise<ParamsResponse> {
    ...
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'Params',
      data,
    );
  ...
  estimateSwapExactAmountIn(
    ...
    return promise.then(data =>
      EstimateSwapExactAmountInResponse.decode(new BinaryReader(data)),
    );
  }
  estimateSwapExactAmountInWithPrimitiveTypes(
    request: EstimateSwapExactAmountInWithPrimitiveTypesRequest,
  ...
  estimateSinglePoolSwapExactAmountIn(
    ...
    const data =
      EstimateSinglePoolSwapExactAmountInRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'EstimateSinglePoolSwapExactAmountIn',
      data,
  ...
  estimateSwapExactAmountOut(
    ...
    return promise.then(data =>
      EstimateSwapExactAmountOutResponse.decode(new BinaryReader(data)),
    );
  }
  estimateSwapExactAmountOutWithPrimitiveTypes(
    request: EstimateSwapExactAmountOutWithPrimitiveTypesRequest,
  ...
  estimateSinglePoolSwapExactAmountOut(
    ...
    const data =
      EstimateSinglePoolSwapExactAmountOutRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'EstimateSinglePoolSwapExactAmountOut',
      data,
  ...
  numPools(request: NumPoolsRequest = {}): Promise<NumPoolsResponse> {
    ...
    return promise.then(data =>
      NumPoolsResponse.decode(new BinaryReader(data)),
    );
  }
  pool(request: PoolRequest): Promise<PoolResponse> {
  ...
  allPools(request: AllPoolsRequest = {}): Promise<AllPoolsResponse> {
    ...
    return promise.then(data =>
      AllPoolsResponse.decode(new BinaryReader(data)),
    );
  }
  listPoolsByDenom(
    request: ListPoolsByDenomRequest,
    ...
    return promise.then(data =>
      ListPoolsByDenomResponse.decode(new BinaryReader(data)),
    );
  }
  spotPrice(request: SpotPriceRequest): Promise<SpotPriceResponse> {
  ...
  totalPoolLiquidity(
    ...
    return promise.then(data =>
      TotalPoolLiquidityResponse.decode(new BinaryReader(data)),
    );
  }
  totalLiquidity(
    request: TotalLiquidityRequest = {},
    ...
    return promise.then(data =>
      TotalLiquidityResponse.decode(new BinaryReader(data)),
    );
  }
  totalVolumeForPool(
    request: TotalVolumeForPoolRequest,
    ...
    return promise.then(data =>
      TotalVolumeForPoolResponse.decode(new BinaryReader(data)),
    );
  }
  tradingPairTakerFee(
    request: TradingPairTakerFeeRequest,
    ...
    return promise.then(data =>
      TradingPairTakerFeeResponse.decode(new BinaryReader(data)),
    );
  }
  estimateTradeBasedOnPriceImpact(
    request: EstimateTradeBasedOnPriceImpactRequest,
    ...
    const data =
      EstimateTradeBasedOnPriceImpactRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'EstimateTradeBasedOnPriceImpact',
      data,
    ...
    return promise.then(data =>
      EstimateTradeBasedOnPriceImpactResponse.decode(new BinaryReader(data)),
    );
  }
  allTakerFeeShareAgreements(
    request: AllTakerFeeShareAgreementsRequest = {},
    ...
    return promise.then(data =>
      AllTakerFeeShareAgreementsResponse.decode(new BinaryReader(data)),
    );
  }
  takerFeeShareAgreementFromDenom(
    request: TakerFeeShareAgreementFromDenomRequest,
    ...
    const data =
      TakerFeeShareAgreementFromDenomRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'TakerFeeShareAgreementFromDenom',
      data,
    ...
    return promise.then(data =>
      TakerFeeShareAgreementFromDenomResponse.decode(new BinaryReader(data)),
    );
  }
  takerFeeShareDenomsToAccruedValue(
    request: TakerFeeShareDenomsToAccruedValueRequest,
    ...
    const data =
      TakerFeeShareDenomsToAccruedValueRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'TakerFeeShareDenomsToAccruedValue',
      data,
    ...
    return promise.then(data =>
      TakerFeeShareDenomsToAccruedValueResponse.decode(new BinaryReader(data)),
    );
  }
  allTakerFeeShareAccumulators(
    request: AllTakerFeeShareAccumulatorsRequest = {},
    ...
    return promise.then(data =>
      AllTakerFeeShareAccumulatorsResponse.decode(new BinaryReader(data)),
    );
  }
  registeredAlloyedPoolFromDenom(
    request: RegisteredAlloyedPoolFromDenomRequest,
    ...
    return promise.then(data =>
      RegisteredAlloyedPoolFromDenomResponse.decode(new BinaryReader(data)),
    );
  }
  registeredAlloyedPoolFromPoolId(
    request: RegisteredAlloyedPoolFromPoolIdRequest,
    ...
    const data =
      RegisteredAlloyedPoolFromPoolIdRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Query',
      'RegisteredAlloyedPoolFromPoolId',
      data,
    ...
    return promise.then(data =>
      RegisteredAlloyedPoolFromPoolIdResponse.decode(new BinaryReader(data)),
    );
  }
  allRegisteredAlloyedPools(
    request: AllRegisteredAlloyedPoolsRequest = {},
    ...
    return promise.then(data =>
      AllRegisteredAlloyedPoolsResponse.decode(new BinaryReader(data)),
    );
  }
}

...
export interface Msg {
  ...
  ): Promise<MsgSetRegisteredAlloyedPoolResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.setTakerFeeShareAgreementForDenom =
      this.setTakerFeeShareAgreementForDenom.bind(this);
  ...
  swapExactAmountIn(
    ...
    const promise = this.rpc.request(
      'symphony.poolmanager.v1beta1.Msg',
      'SwapExactAmountIn',
      data,
    );
  ...
  setTakerFeeShareAgreementForDenom(
    ...
    return promise.then(data =>
      MsgSetTakerFeeShareAgreementForDenomResponse.decode(
  ...
  setRegisteredAlloyedPool(
    ...
    return promise.then(data =>
      MsgSetRegisteredAlloyedPoolResponse.decode(new BinaryReader(data)),
    );
  }
}

...
export const createLCDClient = async ({
  ...
  return {
    ...
    symphony: {
      ...
      oracle: {
        v1beta1: new (await import("./oracle/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      poolincentives: {
      ...
      stablestaking: {
        v1beta1: new (await import("./stablestaking/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      stablestakingincentives: {
        v1beta1: new (await import("./stablestakingincentives/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      ...
      treasury: {
        v1beta1: new (await import("./treasury/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      twap: {

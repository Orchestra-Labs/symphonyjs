...
export interface Query {
  ...
  ): Promise<LiquidityPerTickRangeResponse>;
  /**
  ...
  ): Promise<LiquidityNetInDirectionResponse>;
  /**
  ...
  ): Promise<ClaimableSpreadRewardsResponse>;
  /**
  ...
  ): Promise<ClaimableIncentivesResponse>;
  ...
  ): Promise<TickAccumulatorTrackersResponse>;
  /**
  ...
  ): Promise<NumNextInitializedTicksResponse>;
}
export class QueryClientImpl implements Query {
  ...
  pools(
    ...
    const promise = this.rpc.request(
      'symphony.concentratedliquidity.v1beta1.Query',
      'Pools',
      data,
    );
  ...
  userPositions(request: UserPositionsRequest): Promise<UserPositionsResponse> {
    ...
    return promise.then(data =>
      UserPositionsResponse.decode(new BinaryReader(data)),
    );
  }
  liquidityPerTickRange(
    request: LiquidityPerTickRangeRequest,
    ...
    return promise.then(data =>
      LiquidityPerTickRangeResponse.decode(new BinaryReader(data)),
    );
  }
  liquidityNetInDirection(
    request: LiquidityNetInDirectionRequest,
    ...
    return promise.then(data =>
      LiquidityNetInDirectionResponse.decode(new BinaryReader(data)),
    );
  }
  claimableSpreadRewards(
    request: ClaimableSpreadRewardsRequest,
    ...
    return promise.then(data =>
      ClaimableSpreadRewardsResponse.decode(new BinaryReader(data)),
    );
  }
  claimableIncentives(
    request: ClaimableIncentivesRequest,
    ...
    return promise.then(data =>
      ClaimableIncentivesResponse.decode(new BinaryReader(data)),
    );
  }
  positionById(request: PositionByIdRequest): Promise<PositionByIdResponse> {
    ...
    return promise.then(data =>
      PositionByIdResponse.decode(new BinaryReader(data)),
    );
  }
  poolAccumulatorRewards(
    request: PoolAccumulatorRewardsRequest,
    ...
    return promise.then(data =>
      PoolAccumulatorRewardsResponse.decode(new BinaryReader(data)),
    );
  }
  incentiveRecords(
    request: IncentiveRecordsRequest,
    ...
    return promise.then(data =>
      IncentiveRecordsResponse.decode(new BinaryReader(data)),
    );
  }
  tickAccumulatorTrackers(
    request: TickAccumulatorTrackersRequest,
    ...
    return promise.then(data =>
      TickAccumulatorTrackersResponse.decode(new BinaryReader(data)),
    );
  }
  cFMMPoolIdLinkFromConcentratedPoolId(
    request: CFMMPoolIdLinkFromConcentratedPoolIdRequest,
    ...
    const data =
      CFMMPoolIdLinkFromConcentratedPoolIdRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.concentratedliquidity.v1beta1.Query',
      'CFMMPoolIdLinkFromConcentratedPoolId',
      data,
    ...
    return promise.then(data =>
      CFMMPoolIdLinkFromConcentratedPoolIdResponse.decode(
  ...
  userUnbondingPositions(
    ...
    return promise.then(data =>
      UserUnbondingPositionsResponse.decode(new BinaryReader(data)),
    );
  }
  getTotalLiquidity(
    request: GetTotalLiquidityRequest = {},
    ...
    return promise.then(data =>
      GetTotalLiquidityResponse.decode(new BinaryReader(data)),
    );
  }
  numNextInitializedTicks(
    request: NumNextInitializedTicksRequest,
    ...
    return promise.then(data =>
      NumNextInitializedTicksResponse.decode(new BinaryReader(data)),
    );
  }
}

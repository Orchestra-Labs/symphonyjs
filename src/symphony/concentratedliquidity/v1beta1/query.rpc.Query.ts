...
export class QueryClientImpl implements Query {
  ...
  pools(request: PoolsRequest = {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "Pools", data);
    return promise.then(data => PoolsResponse.decode(new BinaryReader(data)));
  }
  params(request: ParamsRequest = {}): Promise<ParamsResponse> {
    const data = ParamsRequest.encode(request).finish();
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "Params", data);
    return promise.then(data => ParamsResponse.decode(new BinaryReader(data)));
  }
  userPositions(request: UserPositionsRequest): Promise<UserPositionsResponse> {
    const data = UserPositionsRequest.encode(request).finish();
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "UserPositions", data);
  ...
  liquidityPerTickRange(request: LiquidityPerTickRangeRequest): Promise<LiquidityPerTickRangeResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "LiquidityPerTickRange", data);
  ...
  liquidityNetInDirection(request: LiquidityNetInDirectionRequest): Promise<LiquidityNetInDirectionResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "LiquidityNetInDirection", data);
  ...
  claimableSpreadRewards(request: ClaimableSpreadRewardsRequest): Promise<ClaimableSpreadRewardsResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "ClaimableSpreadRewards", data);
  ...
  claimableIncentives(request: ClaimableIncentivesRequest): Promise<ClaimableIncentivesResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "ClaimableIncentives", data);
  ...
  positionById(request: PositionByIdRequest): Promise<PositionByIdResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "PositionById", data);
  ...
  poolAccumulatorRewards(request: PoolAccumulatorRewardsRequest): Promise<PoolAccumulatorRewardsResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "PoolAccumulatorRewards", data);
  ...
  incentiveRecords(request: IncentiveRecordsRequest): Promise<IncentiveRecordsResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "IncentiveRecords", data);
  ...
  tickAccumulatorTrackers(request: TickAccumulatorTrackersRequest): Promise<TickAccumulatorTrackersResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "TickAccumulatorTrackers", data);
  ...
  cFMMPoolIdLinkFromConcentratedPoolId(request: CFMMPoolIdLinkFromConcentratedPoolIdRequest): Promise<CFMMPoolIdLinkFromConcentratedPoolIdResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "CFMMPoolIdLinkFromConcentratedPoolId", data);
  ...
  userUnbondingPositions(request: UserUnbondingPositionsRequest): Promise<UserUnbondingPositionsResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "UserUnbondingPositions", data);
  ...
  getTotalLiquidity(request: GetTotalLiquidityRequest = {}): Promise<GetTotalLiquidityResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "GetTotalLiquidity", data);
  ...
  numNextInitializedTicks(request: NumNextInitializedTicksRequest): Promise<NumNextInitializedTicksResponse> {
    ...
    const promise = this.rpc.request("symphony.concentratedliquidity.v1beta1.Query", "NumNextInitializedTicks", data);

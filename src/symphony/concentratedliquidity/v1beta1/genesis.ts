...
export interface FullTickAminoMsg {
  type: "/symphony.concentratedliquidity.v1beta1.FullTick";
  value: FullTickAmino;
}
/**
 * FullTick contains tick index and pool id along with other tick model
...
export interface PoolDataAminoMsg {
  type: "/symphony.concentratedliquidity.v1beta1.PoolData";
  value: PoolDataAmino;
}
/**
 * PoolData represents a serialized pool along with its ticks
...
export const GenesisState = {
  ...
  is(o: any): o is GenesisState {
    return o && (o.$typeUrl === GenesisState.typeUrl || Params.is(o.params) && Array.isArray(o.poolData) && (!o.poolData.length || PoolData.is(o.poolData[0])) && Array.isArray(o.positionData) && (!o.positionData.length || PositionData.is(o.positionData[0])) && typeof o.nextPositionId === "bigint" && typeof o.nextIncentiveRecordId === "bigint" && typeof o.incentivesAccumulatorPoolIdMigrationThreshold === "bigint" && typeof o.spreadFactorPoolIdMigrationThreshold === "bigint");
  },
  isSDK(o: any): o is GenesisStateSDKType {
    return o && (o.$typeUrl === GenesisState.typeUrl || Params.isSDK(o.params) && Array.isArray(o.pool_data) && (!o.pool_data.length || PoolData.isSDK(o.pool_data[0])) && Array.isArray(o.position_data) && (!o.position_data.length || PositionData.isSDK(o.position_data[0])) && typeof o.next_position_id === "bigint" && typeof o.next_incentive_record_id === "bigint" && typeof o.incentives_accumulator_pool_id_migration_threshold === "bigint" && typeof o.spread_factor_pool_id_migration_threshold === "bigint");
  },

...
import {
  PoolsRequest,
  PoolsResponseSDKType,
  ParamsRequest,
  ParamsResponseSDKType,
  UserPositionsRequest,
  UserPositionsResponseSDKType,
  LiquidityPerTickRangeRequest,
  LiquidityPerTickRangeResponseSDKType,
  LiquidityNetInDirectionRequest,
  LiquidityNetInDirectionResponseSDKType,
  ClaimableSpreadRewardsRequest,
  ClaimableSpreadRewardsResponseSDKType,
  ClaimableIncentivesRequest,
  ClaimableIncentivesResponseSDKType,
  PositionByIdRequest,
  PositionByIdResponseSDKType,
  PoolAccumulatorRewardsRequest,
  PoolAccumulatorRewardsResponseSDKType,
  IncentiveRecordsRequest,
  IncentiveRecordsResponseSDKType,
  TickAccumulatorTrackersRequest,
  TickAccumulatorTrackersResponseSDKType,
  ...
  UserUnbondingPositionsResponseSDKType,
  GetTotalLiquidityRequest,
  GetTotalLiquidityResponseSDKType,
  NumNextInitializedTicksRequest,
  NumNextInitializedTicksResponseSDKType,
} from './query';
export class LCDQueryClient {
  ...
  async pools(
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/pools`;
  ...
  async params(_params: ParamsRequest = {}): Promise<ParamsResponseSDKType> {
    const endpoint = `symphony/concentratedliquidity/v1beta1/params`;
    return await this.req.get<ParamsResponseSDKType>(endpoint);
  }
  /* UserPositions returns all concentrated positions of some address. */
  async userPositions(
    params: UserPositionsRequest,
  ): Promise<UserPositionsResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/positions/${params.address}`;
  ...
  async liquidityPerTickRange(
    params: LiquidityPerTickRangeRequest,
  ): Promise<LiquidityPerTickRangeResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.poolId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/liquidity_per_tick_range`;
    return await this.req.get<LiquidityPerTickRangeResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async liquidityNetInDirection(
    params: LiquidityNetInDirectionRequest,
  ): Promise<LiquidityNetInDirectionResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.poolId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/liquidity_net_in_direction`;
    return await this.req.get<LiquidityNetInDirectionResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async claimableSpreadRewards(
    params: ClaimableSpreadRewardsRequest,
  ): Promise<ClaimableSpreadRewardsResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/claimable_spread_rewards`;
    return await this.req.get<ClaimableSpreadRewardsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async claimableIncentives(
    params: ClaimableIncentivesRequest,
  ): Promise<ClaimableIncentivesResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.positionId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/claimable_incentives`;
    return await this.req.get<ClaimableIncentivesResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async positionById(
    params: PositionByIdRequest,
  ): Promise<PositionByIdResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.positionId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/position_by_id`;
  ...
  async poolAccumulatorRewards(
    params: PoolAccumulatorRewardsRequest,
  ): Promise<PoolAccumulatorRewardsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.poolId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/pool_accum_rewards`;
    return await this.req.get<PoolAccumulatorRewardsResponseSDKType>(
      endpoint,
      options,
    );
  }
  /* IncentiveRecords returns the incentive records for a given poolId */
  async incentiveRecords(
    params: IncentiveRecordsRequest,
  ): Promise<IncentiveRecordsResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.poolId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/incentive_records`;
    return await this.req.get<IncentiveRecordsResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async tickAccumulatorTrackers(
    params: TickAccumulatorTrackersRequest,
  ): Promise<TickAccumulatorTrackersResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.poolId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/tick_accum_trackers`;
    return await this.req.get<TickAccumulatorTrackersResponseSDKType>(
      endpoint,
      options,
    );
  }
  ...
  async cFMMPoolIdLinkFromConcentratedPoolId(
    params: CFMMPoolIdLinkFromConcentratedPoolIdRequest,
  ): Promise<CFMMPoolIdLinkFromConcentratedPoolIdResponseSDKType> {
    const endpoint = `symphony/concentratedliquidity/v1beta1/cfmm_pool_id_link_from_concentrated/${params.concentratedPoolId}`;
    return await this.req.get<CFMMPoolIdLinkFromConcentratedPoolIdResponseSDKType>(
      endpoint,
    );
  }
  /* UserUnbondingPositions returns the position and lock info of unbonding
   positions of the given address. */
  async userUnbondingPositions(
    params: UserUnbondingPositionsRequest,
  ): Promise<UserUnbondingPositionsResponseSDKType> {
    const endpoint = `symphony/concentratedliquidity/v1beta1/user_unbonding_positions/${params.address}`;
  ...
  async getTotalLiquidity(
    _params: GetTotalLiquidityRequest = {},
  ): Promise<GetTotalLiquidityResponseSDKType> {
    const endpoint = `symphony/concentratedliquidity/v1beta1/get_total_liquidity`;
  ...
  async numNextInitializedTicks(
    params: NumNextInitializedTicksRequest,
  ): Promise<NumNextInitializedTicksResponseSDKType> {
    const options: any = {
      params: {},
    };
    if (typeof params?.poolId !== 'undefined') {
    ...
    const endpoint = `symphony/concentratedliquidity/v1beta1/num_next_initialized_ticks`;
    return await this.req.get<NumNextInitializedTicksResponseSDKType>(
      endpoint,
      options,
    );
  }

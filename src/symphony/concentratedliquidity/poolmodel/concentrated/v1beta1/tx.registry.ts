...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/symphony.concentratedliquidity.poolmodel.concentrated.v1beta1.MsgCreateConcentratedPool", MsgCreateConcentratedPool]];

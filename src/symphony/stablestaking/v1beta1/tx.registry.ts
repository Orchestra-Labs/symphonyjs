...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/symphony.stablestaking.v1beta1.MsgStakeTokens", MsgStakeTokens], ["/symphony.stablestaking.v1beta1.MsgUnstakeTokens", MsgUnstakeTokens]];

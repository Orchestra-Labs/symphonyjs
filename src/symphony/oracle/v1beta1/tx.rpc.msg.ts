...
export class MsgClientImpl implements Msg {
  ...
  aggregateExchangeRatePrevote(
    ...
    const promise = this.rpc.request(
      'symphony.oracle.v1beta1.Msg',
      'AggregateExchangeRatePrevote',
      data,
    );
    return promise.then(data =>
      MsgAggregateExchangeRatePrevoteResponse.decode(new BinaryReader(data)),
    );
  }
  aggregateExchangeRateVote(
    request: MsgAggregateExchangeRateVote,
    ...
    return promise.then(data =>
      MsgAggregateExchangeRateVoteResponse.decode(new BinaryReader(data)),
    );
  }
  delegateFeedConsent(
    request: MsgDelegateFeedConsent,
    ...
    return promise.then(data =>
      MsgDelegateFeedConsentResponse.decode(new BinaryReader(data)),
    );
  }
}

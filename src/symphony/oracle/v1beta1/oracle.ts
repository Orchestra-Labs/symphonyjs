...
export const Params = {
  ...
  is(o: any): o is Params {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.votePeriodEpochIdentifier === "string" && typeof o.voteThreshold === "string" && typeof o.rewardBand === "string" && typeof o.rewardDistributionWindow === "bigint" && Array.isArray(o.whitelist) && (!o.whitelist.length || Denom.is(o.whitelist[0])) && typeof o.slashFraction === "string" && typeof o.slashWindowEpochIdentifier === "string" && typeof o.minValidPerWindow === "string");
  },
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.vote_period_epoch_identifier === "string" && typeof o.vote_threshold === "string" && typeof o.reward_band === "string" && typeof o.reward_distribution_window === "bigint" && Array.isArray(o.whitelist) && (!o.whitelist.length || Denom.isSDK(o.whitelist[0])) && typeof o.slash_fraction === "string" && typeof o.slash_window_epoch_identifier === "string" && typeof o.min_valid_per_window === "string");
  },
  isAmino(o: any): o is ParamsAmino {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.vote_period_epoch_identifier === "string" && typeof o.vote_threshold === "string" && typeof o.reward_band === "string" && typeof o.reward_distribution_window === "bigint" && Array.isArray(o.whitelist) && (!o.whitelist.length || Denom.isAmino(o.whitelist[0])) && typeof o.slash_fraction === "string" && typeof o.slash_window_epoch_identifier === "string" && typeof o.min_valid_per_window === "string");
  },
  ...
  fromPartial(object: Partial<Params>): Params {
    ...
    message.slashWindowEpochIdentifier = object.slashWindowEpochIdentifier ?? "";
    message.minValidPerWindow = object.minValidPerWindow ?? "";
    return message;
  },
  fromAmino(object: ParamsAmino): Params {
    const message = createBaseParams();
    if (object.vote_period_epoch_identifier !== undefined && object.vote_period_epoch_identifier !== null) {
    ...
    if (object.slash_window_epoch_identifier !== undefined && object.slash_window_epoch_identifier !== null) {
  ...
  toAmino(message: Params): ParamsAmino {
    const obj: any = {};
    obj.vote_period_epoch_identifier = message.votePeriodEpochIdentifier === "" ? undefined : message.votePeriodEpochIdentifier;
    ...
    obj.slash_window_epoch_identifier = message.slashWindowEpochIdentifier === "" ? undefined : message.slashWindowEpochIdentifier;
...
export const Denom = {
  typeUrl: "/symphony.oracle.v1beta1.Denom",
  is(o: any): o is Denom {
    return o && (o.$typeUrl === Denom.typeUrl || typeof o.name === "string" && typeof o.tobinTax === "string");
  },
  isSDK(o: any): o is DenomSDKType {
    return o && (o.$typeUrl === Denom.typeUrl || typeof o.name === "string" && typeof o.tobin_tax === "string");
  },
...
export const AggregateExchangeRatePrevote = {
  ...
  is(o: any): o is AggregateExchangeRatePrevote {
    return o && (o.$typeUrl === AggregateExchangeRatePrevote.typeUrl || typeof o.hash === "string" && typeof o.voter === "string" && typeof o.submitEpochCounter === "bigint");
  },
  isSDK(o: any): o is AggregateExchangeRatePrevoteSDKType {
    return o && (o.$typeUrl === AggregateExchangeRatePrevote.typeUrl || typeof o.hash === "string" && typeof o.voter === "string" && typeof o.submit_epoch_counter === "bigint");
  },
  ...
  fromPartial(object: Partial<AggregateExchangeRatePrevote>): AggregateExchangeRatePrevote {
    ...
    message.submitEpochCounter = object.submitEpochCounter !== undefined && object.submitEpochCounter !== null ? BigInt(object.submitEpochCounter.toString()) : BigInt(0);
    return message;
  },
  fromAmino(object: AggregateExchangeRatePrevoteAmino): AggregateExchangeRatePrevote {
    ...
    if (object.submit_epoch_counter !== undefined && object.submit_epoch_counter !== null) {
  ...
  toAmino(message: AggregateExchangeRatePrevote): AggregateExchangeRatePrevoteAmino {
    ...
    obj.submit_epoch_counter = message.submitEpochCounter !== BigInt(0) ? message.submitEpochCounter?.toString() : undefined;
    return obj;
  },
...
export const AggregateExchangeRateVote = {
  ...
  isAmino(o: any): o is AggregateExchangeRateVoteAmino {
    return o && (o.$typeUrl === AggregateExchangeRateVote.typeUrl || Array.isArray(o.exchange_rate_tuples) && (!o.exchange_rate_tuples.length || ExchangeRateTuple.isAmino(o.exchange_rate_tuples[0])) && typeof o.voter === "string");
  },

 ...
 * @see proto type: symphony.ibcratelimit.v1beta1.GenesisState
 */
...
export interface GenesisStateProtoMsg {
  typeUrl: '/symphony.ibcratelimit.v1beta1.GenesisState';
  value: Uint8Array;
}
/**
 * GenesisState defines the ibc-rate-limit module's genesis state.
...
export interface GenesisStateAminoMsg {
  type: '/symphony.ibcratelimit.v1beta1.GenesisState';

...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
  ['/symphony.tokenfactory.v1beta1.MsgCreateDenom', MsgCreateDenom],
  ['/symphony.tokenfactory.v1beta1.MsgMint', MsgMint],
  ['/symphony.tokenfactory.v1beta1.MsgBurn', MsgBurn],
  ['/symphony.tokenfactory.v1beta1.MsgChangeAdmin', MsgChangeAdmin],
  ['/symphony.tokenfactory.v1beta1.MsgSetDenomMetadata', MsgSetDenomMetadata],
  ['/symphony.tokenfactory.v1beta1.MsgSetBeforeSendHook', MsgSetBeforeSendHook],
  ['/symphony.tokenfactory.v1beta1.MsgForceTransfer', MsgForceTransfer],
];

...
export const Params = {
  ...
  is(o: any): o is Params {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.reserveAllowableOffset === "string" && typeof o.maxFeeMultiplier === "string" && typeof o.updateTreasuryEpochIdentifier === "string" && typeof o.windowShort === "bigint" && typeof o.windowLong === "bigint" && typeof o.windowProbation === "bigint");
  },
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.reserve_allowable_offset === "string" && typeof o.max_fee_multiplier === "string" && typeof o.update_treasury_epoch_identifier === "string" && typeof o.window_short === "bigint" && typeof o.window_long === "bigint" && typeof o.window_probation === "bigint");
  },
  ...
  fromPartial(object: Partial<Params>): Params {
    ...
    message.updateTreasuryEpochIdentifier = object.updateTreasuryEpochIdentifier ?? "";
  ...
  fromAmino(object: ParamsAmino): Params {
    ...
    if (object.update_treasury_epoch_identifier !== undefined && object.update_treasury_epoch_identifier !== null) {
      message.updateTreasuryEpochIdentifier = object.update_treasury_epoch_identifier;
    }
  ...
  toAmino(message: Params): ParamsAmino {
    ...
    obj.update_treasury_epoch_identifier = message.updateTreasuryEpochIdentifier === "" ? undefined : message.updateTreasuryEpochIdentifier;

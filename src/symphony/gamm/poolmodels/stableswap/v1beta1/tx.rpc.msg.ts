...
export class MsgClientImpl implements Msg {
  ...
  createStableswapPool(request: MsgCreateStableswapPool): Promise<MsgCreateStableswapPoolResponse> {
    ...
    const promise = this.rpc.request("symphony.gamm.poolmodels.stableswap.v1beta1.Msg", "CreateStableswapPool", data);
  ...
  stableSwapAdjustScalingFactors(request: MsgStableSwapAdjustScalingFactors): Promise<MsgStableSwapAdjustScalingFactorsResponse> {
    ...
    const promise = this.rpc.request("symphony.gamm.poolmodels.stableswap.v1beta1.Msg", "StableSwapAdjustScalingFactors", data);

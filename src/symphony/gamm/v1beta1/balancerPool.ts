 ...
 * @see proto type: symphony.gamm.v1beta1.SmoothWeightChangeParams
 */
...
export interface SmoothWeightChangeParamsProtoMsg {
  typeUrl: '/symphony.gamm.v1beta1.SmoothWeightChangeParams';
  value: Uint8Array;
}
/**
 * Parameters for changing the weights in a balancer pool smoothly from
 ...
 *       (target_pool_weights - initial_pool_weights) / (duration)
 *   t > start_time + duration: w(t) = target_pool_weights
 * @name SmoothWeightChangeParamsAmino
 * @package symphony.gamm.v1beta1
 * @see proto type: symphony.gamm.v1beta1.SmoothWeightChangeParams
 */
...
export interface SmoothWeightChangeParamsAminoMsg {
  type: '/symphony.gamm.v1beta1.SmoothWeightChangeParams';
 ...
 *       (target_pool_weights - initial_pool_weights) / (duration)
 *   t > start_time + duration: w(t) = target_pool_weights
 * @name SmoothWeightChangeParamsSDKType
 * @package symphony.gamm.v1beta1
 * @see proto type: symphony.gamm.v1beta1.SmoothWeightChangeParams
 */
 ...
 * @name PoolParams
 * @package symphony.gamm.v1beta1
 * @see proto type: symphony.gamm.v1beta1.PoolParams
 */
...
export interface PoolParamsProtoMsg {
  typeUrl: '/symphony.gamm.v1beta1.PoolParams';
  value: Uint8Array;
}
/**
 * PoolParams defined the parameters that will be managed by the pool
...
export interface PoolParamsAminoMsg {
  type: 'symphony/gamm/BalancerPoolParams';
 ...
 * @name PoolAsset
 * @package symphony.gamm.v1beta1
 * @see proto type: symphony.gamm.v1beta1.PoolAsset
 */
...
export interface PoolAssetProtoMsg {
  typeUrl: '/symphony.gamm.v1beta1.PoolAsset';
  value: Uint8Array;
}
/**
 * Pool asset is an internal struct that combines the amount of the
...
export interface PoolAssetAminoMsg {
  type: '/symphony.gamm.v1beta1.PoolAsset';
 ...
 * @name Pool
 * @package symphony.gamm.v1beta1
 * @see proto type: symphony.gamm.v1beta1.Pool
 */
export interface Pool {
  $typeUrl?: '/symphony.gamm.v1beta1.Pool';
  address: string;
  id: bigint;
...
export interface PoolAminoMsg {
  type: 'symphony/gamm/BalancerPool';
  value: PoolAmino;
}
/**
 * @name PoolSDKType
...
export const PoolParams = {
  typeUrl: '/symphony.gamm.v1beta1.PoolParams',
  aminoType: 'symphony/gamm/BalancerPoolParams',
...
export const Pool = {
  typeUrl: '/symphony.gamm.v1beta1.Pool',
  aminoType: 'symphony/gamm/BalancerPool',
  is(o: any): o is Pool {
    return (
      o &&

...
export interface Query {
  ...
  ): Promise<QueryPoolsWithFilterResponse>;
  /** Deprecated: please use the alternative in x/poolmanager */
  ...
  ): Promise<QueryCalcJoinPoolSharesResponse>;
...
export class QueryClientImpl implements Query {
  ...
  numPools(request: QueryNumPoolsRequest = {}): Promise<QueryNumPoolsResponse> {
    ...
    return promise.then(data =>
      QueryNumPoolsResponse.decode(new BinaryReader(data)),
    );
  }
  totalLiquidity(
    request: QueryTotalLiquidityRequest = {},
    ...
    return promise.then(data =>
      QueryTotalLiquidityResponse.decode(new BinaryReader(data)),
    );
  }
  poolsWithFilter(
    request: QueryPoolsWithFilterRequest,
    ...
    return promise.then(data =>
      QueryPoolsWithFilterResponse.decode(new BinaryReader(data)),
    );
  }
  pool(request: QueryPoolRequest): Promise<QueryPoolResponse> {
  ...
  poolType(request: QueryPoolTypeRequest): Promise<QueryPoolTypeResponse> {
    ...
    return promise.then(data =>
      QueryPoolTypeResponse.decode(new BinaryReader(data)),
    );
  }
  calcJoinPoolNoSwapShares(
    request: QueryCalcJoinPoolNoSwapSharesRequest,
    ...
    return promise.then(data =>
      QueryCalcJoinPoolNoSwapSharesResponse.decode(new BinaryReader(data)),
    );
  }
  calcJoinPoolShares(
    request: QueryCalcJoinPoolSharesRequest,
    ...
    return promise.then(data =>
      QueryCalcJoinPoolSharesResponse.decode(new BinaryReader(data)),
    );
  }
  calcExitPoolCoinsFromShares(
    request: QueryCalcExitPoolCoinsFromSharesRequest,
    ...
    const data =
      QueryCalcExitPoolCoinsFromSharesRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.gamm.v1beta1.Query',
      'CalcExitPoolCoinsFromShares',
      data,
    ...
    return promise.then(data =>
      QueryCalcExitPoolCoinsFromSharesResponse.decode(new BinaryReader(data)),
    );
  }
  poolParams(
    ...
    return promise.then(data =>
      QueryPoolParamsResponse.decode(new BinaryReader(data)),
    );
  }
  totalPoolLiquidity(
    request: QueryTotalPoolLiquidityRequest,
    ...
    return promise.then(data =>
      QueryTotalPoolLiquidityResponse.decode(new BinaryReader(data)),
    );
  }
  totalShares(
    request: QueryTotalSharesRequest,
    ...
    return promise.then(data =>
      QueryTotalSharesResponse.decode(new BinaryReader(data)),
    );
  }
  spotPrice(request: QuerySpotPriceRequest): Promise<QuerySpotPriceResponse> {
  ...
  estimateSwapExactAmountIn(
    ...
    return promise.then(data =>
      QuerySwapExactAmountInResponse.decode(new BinaryReader(data)),
    );
  }
  estimateSwapExactAmountOut(
    request: QuerySwapExactAmountOutRequest,
    ...
    return promise.then(data =>
      QuerySwapExactAmountOutResponse.decode(new BinaryReader(data)),
    );
  }
  concentratedPoolIdLinkFromCFMM(
    request: QueryConcentratedPoolIdLinkFromCFMMRequest,
    ...
    const data =
      QueryConcentratedPoolIdLinkFromCFMMRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.gamm.v1beta1.Query',
      'ConcentratedPoolIdLinkFromCFMM',
      data,
    ...
    return promise.then(data =>
      QueryConcentratedPoolIdLinkFromCFMMResponse.decode(
  ...
  cFMMConcentratedPoolLinks(
    ...
    return promise.then(data =>
      QueryCFMMConcentratedPoolLinksResponse.decode(new BinaryReader(data)),
    );
  }
  params(request: ParamsRequest = {}): Promise<ParamsResponse> {

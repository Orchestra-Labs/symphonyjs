...
import * as symphonyOracleV1beta1TxRegistry from "./oracle/v1beta1/tx.registry";
...
import * as symphonyStablestakingV1beta1TxRegistry from "./stablestaking/v1beta1/tx.registry";
...
import * as symphonyOracleV1beta1TxAmino from "./oracle/v1beta1/tx.amino";
...
import * as symphonyStablestakingV1beta1TxAmino from "./stablestaking/v1beta1/tx.amino";
...
export const symphonyAminoConverters = {
  ...
  ...symphonyOracleV1beta1TxAmino.AminoConverter,
  ...
  ...symphonyStablestakingV1beta1TxAmino.AminoConverter,
...
export const symphonyProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...symphonyBridgeV1beta1TxRegistry.registry, ...symphonyConcentratedliquidityPoolmodelConcentratedV1beta1TxRegistry.registry, ...symphonyConcentratedliquidityV1beta1TxRegistry.registry, ...symphonyGammPoolmodelsBalancerV1beta1TxRegistry.registry, ...symphonyGammPoolmodelsStableswapV1beta1TxRegistry.registry, ...symphonyGammV1beta1TxRegistry.registry, ...symphonyIbchooksTxRegistry.registry, ...symphonyIncentivesTxRegistry.registry, ...symphonyLockupTxRegistry.registry, ...symphonyMarketV1beta1TxRegistry.registry, ...symphonyOracleV1beta1TxRegistry.registry, ...symphonyPoolmanagerV1beta1TxRegistry.registry, ...symphonyProtorevV1beta1TxRegistry.registry, ...symphonySmartaccountV1beta1TxRegistry.registry, ...symphonyStablestakingV1beta1TxRegistry.registry, ...symphonySuperfluidTxRegistry.registry, ...symphonyTokenfactoryV1beta1TxRegistry.registry, ...symphonyValsetprefV1beta1TxRegistry.registry];
...
export const getSigningSymphonyClient = async ({
  ...
  const {
    registry,
    aminoTypes
  } = getSigningSymphonyClientOptions({
    defaultTypes
  });

...
export interface MigrationRecordsAminoMsg {
  type: '/symphony.poolincentives.v1beta1.MigrationRecords';
...
export interface BalancerToConcentratedPoolLinkAminoMsg {
  type: '/symphony.poolincentives.v1beta1.BalancerToConcentratedPoolLink';
      ...
      (o.$typeUrl === MigrationRecords.typeUrl ||
        (Array.isArray(o.balancerToConcentratedPoolLinks) &&
          (!o.balancerToConcentratedPoolLinks.length ||
            BalancerToConcentratedPoolLink.is(
              o.balancerToConcentratedPoolLinks[0],
            ))))
    );
  },
      ...
      (o.$typeUrl === MigrationRecords.typeUrl ||
        (Array.isArray(o.balancer_to_concentrated_pool_links) &&
          (!o.balancer_to_concentrated_pool_links.length ||
            BalancerToConcentratedPoolLink.isSDK(
              o.balancer_to_concentrated_pool_links[0],
            ))))
    );
  },
  isAmino(o: any): o is MigrationRecordsAmino {
    return (
      ...
      (o.$typeUrl === MigrationRecords.typeUrl ||
        (Array.isArray(o.balancer_to_concentrated_pool_links) &&
          (!o.balancer_to_concentrated_pool_links.length ||
            BalancerToConcentratedPoolLink.isAmino(
              o.balancer_to_concentrated_pool_links[0],
            ))))
    );
  },
...
export const BalancerToConcentratedPoolLink = {
  ...
  toProtoMsg(
    ...
    return {
      typeUrl:
        '/symphony.poolincentives.v1beta1.BalancerToConcentratedPoolLink',
      value: BalancerToConcentratedPoolLink.encode(message).finish(),
    };
  },
};
GlobalDecoderRegistry.register(
  BalancerToConcentratedPoolLink.typeUrl,
  BalancerToConcentratedPoolLink,
);

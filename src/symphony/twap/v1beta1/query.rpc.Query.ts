...
export class QueryClientImpl implements Query {
  ...
  arithmeticTwap(
    ...
    return promise.then(data =>
      ArithmeticTwapResponse.decode(new BinaryReader(data)),
    );
  }
  arithmeticTwapToNow(
    request: ArithmeticTwapToNowRequest,
    ...
    return promise.then(data =>
      ArithmeticTwapToNowResponse.decode(new BinaryReader(data)),
    );
  }
  geometricTwap(request: GeometricTwapRequest): Promise<GeometricTwapResponse> {
    ...
    return promise.then(data =>
      GeometricTwapResponse.decode(new BinaryReader(data)),
    );
  }
  geometricTwapToNow(
    request: GeometricTwapToNowRequest,
    ...
    return promise.then(data =>
      GeometricTwapToNowResponse.decode(new BinaryReader(data)),
    );
  }
}

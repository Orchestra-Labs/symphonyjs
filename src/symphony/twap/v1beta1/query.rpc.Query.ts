...
export class QueryClientImpl implements Query {
  ...
  params(request: ParamsRequest = {}): Promise<ParamsResponse> {
    ...
    const promise = this.rpc.request("symphony.twap.v1beta1.Query", "Params", data);
    return promise.then(data => ParamsResponse.decode(new BinaryReader(data)));
  }
  arithmeticTwap(request: ArithmeticTwapRequest): Promise<ArithmeticTwapResponse> {
    const data = ArithmeticTwapRequest.encode(request).finish();
    const promise = this.rpc.request("symphony.twap.v1beta1.Query", "ArithmeticTwap", data);
  ...
  arithmeticTwapToNow(request: ArithmeticTwapToNowRequest): Promise<ArithmeticTwapToNowResponse> {
    ...
    const promise = this.rpc.request("symphony.twap.v1beta1.Query", "ArithmeticTwapToNow", data);
  ...
  geometricTwap(request: GeometricTwapRequest): Promise<GeometricTwapResponse> {
    ...
    const promise = this.rpc.request("symphony.twap.v1beta1.Query", "GeometricTwap", data);
  ...
  geometricTwapToNow(request: GeometricTwapToNowRequest): Promise<GeometricTwapToNowResponse> {
    ...
    const promise = this.rpc.request("symphony.twap.v1beta1.Query", "GeometricTwapToNow", data);

...
export interface TwapRecordAminoMsg {
  type: "/symphony.twap.v1beta1.TwapRecord";
...
export interface PruningStateAminoMsg {
  type: "/symphony.twap.v1beta1.PruningState";
...
export const PruningState = {
  ...
  is(o: any): o is PruningState {
    return o && (o.$typeUrl === PruningState.typeUrl || typeof o.isPruning === "boolean" && Timestamp.is(o.lastKeptTime) && typeof o.lastSeenPoolId === "bigint");
  },
  isSDK(o: any): o is PruningStateSDKType {
    return o && (o.$typeUrl === PruningState.typeUrl || typeof o.is_pruning === "boolean" && Timestamp.isSDK(o.last_kept_time) && typeof o.last_seen_pool_id === "bigint");
  },
  isAmino(o: any): o is PruningStateAmino {
    return o && (o.$typeUrl === PruningState.typeUrl || typeof o.is_pruning === "boolean" && Timestamp.isAmino(o.last_kept_time) && typeof o.last_seen_pool_id === "bigint");
  },

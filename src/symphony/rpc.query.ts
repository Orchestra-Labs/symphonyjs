...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    symphony: {
      bridge: {
        v1beta1: (
          await import('./bridge/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      concentratedliquidity: {
        v1beta1: (
          await import('./concentratedliquidity/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      cosmwasmpool: {
        v1beta1: (
          await import('./cosmwasmpool/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      downtimedetector: {
        v1beta1: (
          await import('./downtimedetector/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      epochs: {
        v1beta1: (
          await import('./epochs/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      gamm: {
        v1beta1: (
          await import('./gamm/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
        v2: (await import('./gamm/v2/query.rpc.Query')).createRpcQueryExtension(
          client,
        ),
      },
      ibcratelimit: {
        v1beta1: (
          await import('./ibcratelimit/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      incentives: (
        await import('./incentives/query.rpc.Query')
      ).createRpcQueryExtension(client),
      lockup: (
      ...
      market: {
        v1beta1: (
          await import('./market/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      mint: {
        v1beta1: (
      ...
      oracle: {
        v1beta1: (
          await import('./oracle/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      poolincentives: {
        v1beta1: (
          await import('./poolincentives/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      poolmanager: {
        v1beta1: (
          await import('./poolmanager/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
        v2: (
      ...
      stablestaking: {
        v1beta1: (
          await import('./stablestaking/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      ...
      superfluid: (
        await import('./superfluid/query.rpc.Query')
      ).createRpcQueryExtension(client),
      tokenfactory: {
        v1beta1: (
          await import('./tokenfactory/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      treasury: {
        v1beta1: (
          await import('./treasury/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      twap: {
        v1beta1: (
          await import('./twap/v1beta1/query.rpc.Query')
        ).createRpcQueryExtension(client),
      },
      txfees: {
        v1beta1: (

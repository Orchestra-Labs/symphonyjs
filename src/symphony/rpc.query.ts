...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    symphony: {
      ...
      stablestaking: {
        v1beta1: (await import("./stablestaking/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      stablestakingincentives: {
        v1beta1: (await import("./stablestakingincentives/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      ...
      treasury: {
        v1beta1: (await import("./treasury/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      twap: {

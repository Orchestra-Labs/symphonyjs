...
export interface MsgSetFeeTokensProtoMsg {
  typeUrl: '/symphony.txfees.v1beta1.MsgSetFeeTokens';
  value: Uint8Array;
}
/** ===================== MsgSetFeeTokens */
...
export interface MsgSetFeeTokensResponseProtoMsg {
  typeUrl: '/symphony.txfees.v1beta1.MsgSetFeeTokensResponse';
  value: Uint8Array;
}
export interface MsgSetFeeTokensResponseAmino {}
export interface MsgSetFeeTokensResponseAminoMsg {
  type: '/symphony.txfees.v1beta1.MsgSetFeeTokensResponse';

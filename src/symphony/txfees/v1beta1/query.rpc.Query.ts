...
import { QueryFeeTokensRequest, QueryFeeTokensResponse, QueryDenomSpotPriceRequest, QueryDenomSpotPriceResponse, QueryEipBaseFeeRequest, QueryEipBaseFeeResponse } from "./query";
...
export class QueryClientImpl implements Query {
  ...
  feeTokens(request: QueryFeeTokensRequest = {}): Promise<QueryFeeTokensResponse> {
    ...
    const promise = this.rpc.request("symphony.txfees.v1beta1.Query", "FeeTokens", data);
  ...
  denomSpotPrice(request: QueryDenomSpotPriceRequest): Promise<QueryDenomSpotPriceResponse> {
    ...
    const promise = this.rpc.request("symphony.txfees.v1beta1.Query", "DenomSpotPrice", data);
  ...
  getEipBaseFee(request: QueryEipBaseFeeRequest = {}): Promise<QueryEipBaseFeeResponse> {
    ...
    const promise = this.rpc.request("symphony.txfees.v1beta1.Query", "GetEipBaseFee", data);

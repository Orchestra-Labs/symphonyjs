...
export const Params = {
  ...
  is(o: any): o is Params {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.swapFeesEpochIdentifier === "string");
  },
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.swap_fees_epoch_identifier === "string");
  },
  ...
  fromAmino(object: ParamsAmino): Params {
    const message = createBaseParams();
    if (object.swap_fees_epoch_identifier !== undefined && object.swap_fees_epoch_identifier !== null) {
  ...
  toAmino(message: Params): ParamsAmino {
    const obj: any = {};
    obj.swap_fees_epoch_identifier = message.swapFeesEpochIdentifier === "" ? undefined : message.swapFeesEpochIdentifier;
    return obj;
  },

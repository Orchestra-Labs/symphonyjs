...
import {
  ...
  ContractInfoByPoolIdResponseSDKType,
} from './query';
export class LCDQueryClient {
  ...
  async pools(
    ...
    const endpoint = `symphony/cosmwasmpool/v1beta1/pools`;
  ...
  async params(_params: ParamsRequest = {}): Promise<ParamsResponseSDKType> {
    const endpoint = `symphony/cosmwasmpool/v1beta1/params`;
    return await this.req.get<ParamsResponseSDKType>(endpoint);
  }
  /* ContractInfoByPoolId */
  async contractInfoByPoolId(
    params: ContractInfoByPoolIdRequest,
  ): Promise<ContractInfoByPoolIdResponseSDKType> {
    const options: any = {
      params: {},
    };
    ...
    const endpoint = `symphony/cosmwasmpool/v1beta1/contract_info`;
    return await this.req.get<ContractInfoByPoolIdResponseSDKType>(
      endpoint,
      options,
    );
  }

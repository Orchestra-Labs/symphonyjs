...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/symphony.lockup.MsgLockTokens", MsgLockTokens], ["/symphony.lockup.MsgBeginUnlockingAll", MsgBeginUnlockingAll], ["/symphony.lockup.MsgBeginUnlocking", MsgBeginUnlocking], ["/symphony.lockup.MsgExtendLockup", MsgExtendLockup], ["/symphony.lockup.MsgForceUnlock", MsgForceUnlock], ["/symphony.lockup.MsgSetRewardReceiverAddress", MsgSetRewardReceiverAddress]];

...
export interface Query {
  ...
  ): Promise<UpcomingGaugesPerDenomResponse>;
  /**
...
export class QueryClientImpl implements Query {
  ...
  moduleToDistributeCoins(
    ...
    const promise = this.rpc.request(
      'symphony.incentives.Query',
      'ModuleToDistributeCoins',
      data,
    );
    return promise.then(data =>
      ModuleToDistributeCoinsResponse.decode(new BinaryReader(data)),
    );
  }
  gaugeByID(request: GaugeByIDRequest): Promise<GaugeByIDResponse> {
    ...
    return promise.then(data =>
      GaugeByIDResponse.decode(new BinaryReader(data)),
    );
  }
  gauges(
  ...
  activeGauges(
    ...
    return promise.then(data =>
      ActiveGaugesResponse.decode(new BinaryReader(data)),
    );
  }
  activeGaugesPerDenom(
    request: ActiveGaugesPerDenomRequest,
    ...
    return promise.then(data =>
      ActiveGaugesPerDenomResponse.decode(new BinaryReader(data)),
    );
  }
  upcomingGauges(
    request: UpcomingGaugesRequest = {
    ...
    return promise.then(data =>
      UpcomingGaugesResponse.decode(new BinaryReader(data)),
    );
  }
  upcomingGaugesPerDenom(
    request: UpcomingGaugesPerDenomRequest,
    ...
    return promise.then(data =>
      UpcomingGaugesPerDenomResponse.decode(new BinaryReader(data)),
    );
  }
  rewardsEst(request: RewardsEstRequest): Promise<RewardsEstResponse> {
    ...
    return promise.then(data =>
      RewardsEstResponse.decode(new BinaryReader(data)),
    );
  }
  lockableDurations(
    request: QueryLockableDurationsRequest = {},
  ...
  allGroups(
  ...
  ): Promise<QueryAllGroupsResponse> {
    ...
    return promise.then(data =>
      QueryAllGroupsResponse.decode(new BinaryReader(data)),
    );
  }
  allGroupsGauges(
    request: QueryAllGroupsGaugesRequest = {},
    ...
    return promise.then(data =>
      QueryAllGroupsGaugesResponse.decode(new BinaryReader(data)),
    );
  }
  allGroupsWithGauge(
    request: QueryAllGroupsWithGaugeRequest = {},
    ...
    return promise.then(data =>
      QueryAllGroupsWithGaugeResponse.decode(new BinaryReader(data)),
    );
  }
  groupByGroupGaugeID(
    request: QueryGroupByGroupGaugeIDRequest,
    ...
    return promise.then(data =>
      QueryGroupByGroupGaugeIDResponse.decode(new BinaryReader(data)),
    );
  }
  currentWeightByGroupGaugeID(
    request: QueryCurrentWeightByGroupGaugeIDRequest,
    ...
    const data =
      QueryCurrentWeightByGroupGaugeIDRequest.encode(request).finish();
    const promise = this.rpc.request(
      'symphony.incentives.Query',
      'CurrentWeightByGroupGaugeID',
      data,
    ...
    return promise.then(data =>
      QueryCurrentWeightByGroupGaugeIDResponse.decode(new BinaryReader(data)),
    );
  }
  params(request: ParamsRequest = {}): Promise<ParamsResponse> {

...
export class QueryClientImpl implements Query {
  ...
  moduleToDistributeCoins(request: ModuleToDistributeCoinsRequest = {}): Promise<ModuleToDistributeCoinsResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "ModuleToDistributeCoins", data);
  ...
  gaugeByID(request: GaugeByIDRequest): Promise<GaugeByIDResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "GaugeByID", data);
  ...
  gauges(request: GaugesRequest = {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "Gauges", data);
  ...
  activeGauges(request: ActiveGaugesRequest = {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "ActiveGauges", data);
  ...
  activeGaugesPerDenom(request: ActiveGaugesPerDenomRequest): Promise<ActiveGaugesPerDenomResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "ActiveGaugesPerDenom", data);
  ...
  upcomingGauges(request: UpcomingGaugesRequest = {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "UpcomingGauges", data);
  ...
  upcomingGaugesPerDenom(request: UpcomingGaugesPerDenomRequest): Promise<UpcomingGaugesPerDenomResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "UpcomingGaugesPerDenom", data);
  ...
  rewardsEst(request: RewardsEstRequest): Promise<RewardsEstResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "RewardsEst", data);
  ...
  lockableDurations(request: QueryLockableDurationsRequest = {}): Promise<QueryLockableDurationsResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "LockableDurations", data);
  ...
  allGroups(request: QueryAllGroupsRequest = {}): Promise<QueryAllGroupsResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "AllGroups", data);
  ...
  allGroupsGauges(request: QueryAllGroupsGaugesRequest = {}): Promise<QueryAllGroupsGaugesResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "AllGroupsGauges", data);
  ...
  allGroupsWithGauge(request: QueryAllGroupsWithGaugeRequest = {}): Promise<QueryAllGroupsWithGaugeResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "AllGroupsWithGauge", data);
  ...
  groupByGroupGaugeID(request: QueryGroupByGroupGaugeIDRequest): Promise<QueryGroupByGroupGaugeIDResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "GroupByGroupGaugeID", data);
  ...
  currentWeightByGroupGaugeID(request: QueryCurrentWeightByGroupGaugeIDRequest): Promise<QueryCurrentWeightByGroupGaugeIDResponse> {
    ...
    const promise = this.rpc.request("symphony.incentives.Query", "CurrentWeightByGroupGaugeID", data);
    return promise.then(data => QueryCurrentWeightByGroupGaugeIDResponse.decode(new BinaryReader(data)));
  }
  params(request: ParamsRequest = {}): Promise<ParamsResponse> {
    const data = ParamsRequest.encode(request).finish();
    const promise = this.rpc.request("symphony.incentives.Query", "Params", data);
